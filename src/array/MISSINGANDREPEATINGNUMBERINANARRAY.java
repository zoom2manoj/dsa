...
public class MISSINGANDREPEATINGNUMBERINANARRAY {

	static void getMissingAndRepeating(int arr[], int n)
    {
       int xors = 0;
       int i;
       int x = 0;
    ...
    public static void main(String[] args)
    {
       ...
       //getMissingAndRepeating(arr, arr.length);
       getMissingAndRepeating2(arr, arr.length);
       
    }
	private static void getMissingAndRepeating2(int[] arr, int length) {
		// TODO Auto-generated method stub
		int a , b;
		long actualSum = length*(length+1)/2;
		long actualSqSum = length*(length+1)*(2*length+1)/6;
		long sum =0, sqSum=0;
		...
		int x= (int) (actualSum-sum);
		int y = (int) ((actualSqSum-sqSum)/x);
